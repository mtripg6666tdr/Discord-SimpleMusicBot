...
- ❕Changing the prefix
  ...
  - If you're running your own instance, you can change the bot's default prefix by editing `config.json`.(prefixes of multiple letters supported)(prefixes of multiple letters supported)(prefixes of multiple letters supported)(prefixes of multiple letters supported)
