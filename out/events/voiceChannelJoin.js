...
exports.onVoiceChannelJoin = onVoiceChannelJoin;
const tslib_1 = require("tslib");
const i18next_1 = tslib_1.__importDefault(require("i18next"));
const GuildDataContainerWithBgm_1 = require("../Structure/GuildDataContainerWithBgm");
async function onVoiceChannelJoin(member, newChannel) {
    ...
    if (member.id === this._client.user.id) {
        ...
        if (member.voiceState?.suppress || member.voiceState?.mute) {
            ...
            const voiceChannel = this._client.getChannel(newChannel.id);
            if (!("guild" in voiceChannel))
                return;
            voiceChannel.guild.editMember(this._client.user.id, {
                ...
                voiceChannel.guild.editUserVoiceState(this._client.user.id, {
                    ...
                    this._client.rest.channels.createMessage(this.guildData.get(newChannel.guild.id).boundTextChannel, {
                        content: `:sob:${i18next_1.default.t("suppressed", { lng: server.locale })}`,
                    })
    ...
    if (server instanceof GuildDataContainerWithBgm_1.GuildDataContainerWithBgm
...
//# sourceMappingURL=voiceChannelJoin.js.map