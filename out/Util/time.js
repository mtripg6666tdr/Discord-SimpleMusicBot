...
exports.calcMinSec = calcMinSec;
exports.calcHourMinSec = calcHourMinSec;
exports.HourMinSecToString = HourMinSecToString;
exports.calcTime = calcTime;
exports.colonSplittedTimeToSeconds = colonSplittedTimeToSeconds;
/**
 * 合計時間(秒)からゼロ補完された分および秒を計算します。
 * @param totalSec 合計時間(秒)
 * @returns [ゼロ補完された分,ゼロ補完された秒]
 */
function calcMinSec(totalSec, { fixedLength = 0 } = {}) {
 ...
 */
function calcHourMinSec(totalSec, { fixedLength = 0 } = {}) {
    const sec = totalSec % 60;
 ...
 * @returns
 */
function HourMinSecToString([hour, min, sec], t) {
...
function colonSplittedTimeToSeconds(colonSplittedTime) {
