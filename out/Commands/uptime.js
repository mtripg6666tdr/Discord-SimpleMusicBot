...
class Uptime extends _1.BaseCommand {
    ...
    async run(message, context) {
        ...
        const embed = new helper_1.MessageEmbedBuilder()
            ...
            .addField(t("commands:uptime.elapsedAfterInstantiated"), t("commands:uptime.datetimeLabel", { hour: insta[0], min: insta[1], sec: insta[2] }))
            .addField(t("commands:uptime.elapsedAfterConnected"), t("commands:uptime.datetimeLabel", { hour: ready[0], min: ready[1], sec: ready[2] }))
            .addField(t("commands:uptime.registeredServerCount"), t("commands:uptime.serverCount", { count: context.bot.databaseCount }))
