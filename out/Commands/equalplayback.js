...
let EquallyPlayback = (() => {
    ...
    let _run_decorators;
    return _a = class EquallyPlayback extends _classSuper {
            constructor() {
                super({
            ...
            async run(command, context) {
                ...
                if (context.server.preferences.equallyPlayback) {
                    ...
                    const embed = new helper_1.MessageEmbedBuilder()
                        ...
                        .setColor((0, color_1.getColor)("EQUALLY"))
                        .toOceanic();
...
exports.default = EquallyPlayback;
//# sourceMappingURL=equalplayback.js.map