...
let LeaveClean = (() => {
    ...
    let _run_decorators;
    return _a = class LeaveClean extends _classSuper {
            constructor() {
                super({
            ...
            async run(message, context) {
                ...
                await message.reply(removed >= 1
                    ? `✅${t("commands:leaveclean.removed", { count: removed })}`
                    : t("commands:leaveclean.removedNothing")).catch(this.logger.error);
            }
        },
        (() => {
...
exports.default = LeaveClean;
//# sourceMappingURL=leaveclean.js.map