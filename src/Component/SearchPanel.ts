...
export class SearchPanel extends EventEmitter {
  ...
  constructor(
    protected readonly _commandMessage: CommandMessage,
        ...
        embeds: [
          new Helper.MessageEmbedBuilder()
            ...
            .setFooter({
              ...
              text: Util.config.noMessageContent
  ...
  override on<T extends keyof SearchPanelEvents>(
    eventName: T,
    listener: (...args: SearchPanelEvents[T]) => void,
  ) {
    return super.on(eventName, listener);
  }

  override once<T extends keyof SearchPanelEvents>(
    eventName: T,
    listener: (...args: SearchPanelEvents[T]) => void,
  ) {
    return super.on(eventName, listener);
  ...
  override off<T extends keyof SearchPanelEvents>(
    eventName: T,
    listener: (...args: SearchPanelEvents[T]) => void,
  ) {
